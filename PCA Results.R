omnibus<-cbind(spatiotemporal$GROUP, spatiotemporal$METRIC_CLEAR,spatiotemporal$METRIC_RED,spatiotemporal$TOPOLOGICAL_CLEAR,spatiotemporal$TOPOLOGICAL_RED,spatiotemporal$LOCREC_CLEAR,spatiotemporal$LOCREC_RED, spatiotemporal$OBJECTREC_CLEAR,spatiotemporal$OBJECTREC_RED,spatiotemporal$NOVEL_CLEAR,spatiotemporal$NOVEL_RED,spatiotemporal$TEMPORAL_CLEAR,spatiotemporal$TEMPORAL_RED,spatiotemporal$ALTERNATIONS,capellini$Latency, capellini$Atypical_Paw_Together,capellini$Atypical_NoContact,capellini$Atypical_Mouth_Pull,capellini$Sum_Atypical,nesting$latency_contact, nesting$latency_dig,nesting$latency_finish,response_factors$response_changepoints, response_factors$response_perseverative,response_factors$response_regressive, neophagia$latency_novelfood,neophagia$latency_novelenvironment,neophagia$latency_both)
